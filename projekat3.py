...
carTrain['Children_Percentage'] = carTrain['Child_Count'] / \
    carTrain['Client_Family_Members']
carTest['Children_Percentage'] = carTest['Child_Count'] / \
    carTest['Client_Family_Members']
...
oneHot = ["Accompany_Client", "Client_Income_Type",
          "Client_Gender", "Client_Housing_Type", "Client_Occupation"]
...
undersampler = RandomUnderSampler(
    sampling_strategy={0: 9800, 1: 1800}, random_state=None, replacement=False)
...
predvidjanjaCSV = pd.DataFrame(
    {'ClientId': carTest['ID'].astype(int), 'Default': predTest.astype(int)})
predvidjanjaCSV.to_csv(
    'C:\\Users\\pcpc\\Desktop\\projekat\\resenje.csv', index=0)
